...
### **/listings/listing/amenities/:id**

An enpoint used to return an array of all the ammenities for a specific property.
...
- **Success Response:**
  ...
  If successful you will be returned an array of ammentities for specified property
...
- **Sample Call:**
  ...
  var config = {
    method: 'get',
    url:
      'https://cit41200-u4-earthbnb.uc.r.appspot.com/api/v1/listings/listing/amenities/7920539',
    headers: {},
  };
